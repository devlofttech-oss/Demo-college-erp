...
function buildEffectiveUser(nextUser, profile = {}) {
  ...
  return {
    ...nextUser,
    name: profile?.name || nextUser.displayName || nextUser.email || '',
    email: profile?.email || nextUser.email || '',
    displayName: profile?.displayName || nextUser.displayName || profile?.name || '',
    ...
    employeeId: profile?.employeeId || profile?.displayId || '',
    sourceCollection: profile?.sourceCollection || '',
    sourceRecordId: profile?.sourceRecordId || profile?.staffRecordId || profile?.recordId || '',
    staffRecordId: profile?.staffRecordId || profile?.sourceRecordId || '',
