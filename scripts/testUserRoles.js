...
assert.equal(canAccess(defaultRoles, 'admin', 'academicCurriculum.view'), false);
assert.equal(canAccess(defaultRoles, 'admin', 'academics.view'), false);
assert.equal(canAccess(defaultRoles, 'admin', 'notices.view'), false);
assert.equal(canAccess(defaultRoles, 'admin', 'notices.create'), false);
...
assert.equal(canAccess(defaultRoles, 'admin', 'parentPortal.viewAll'), true);
...
assert.equal(canAccess(defaultRoles, 'faculty', 'attendance.markStudents'), false);
...
assert.equal(canAccess(defaultRoles, 'faculty', 'exams.view'), true);
