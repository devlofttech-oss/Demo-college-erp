...
const schemas = {
  ...
  feeAssignments: ['feeStructureId', 'studentRecordId', 'studentId', 'studentName', 'classKey', 'academicYear', 'courseCode', 'courseName', 'admissionFee', 'applicationFee', 'pocketArticleFee', 'tuitionFee', 'libraryFee', 'labFee', 'transportFee', 'totalAmount', 'paidAmount', 'adjustmentAmount', 'dueAmount', 'dueDate', 'manualDueItems', 'status', 'feeYearLabel', 'seedSource'],
  feeCollections: ['assignmentId', 'studentRecordId', 'studentId', 'studentName', 'amount', 'academicYear', 'paymentMode', 'referenceNo', 'paymentDate', 'manualDueItems', 'status'],
