...
Object.assign(clientReadySeed, {
  ...
  users: {
    ...
    a4cxT4Q5z9Uv4ICpvkmeg2KU9Pi2: {
      uid: 'a4cxT4Q5z9Uv4ICpvkmeg2KU9Pi2',
      name: 'Devloft Tech',
      email: 'devlofttech@gmail.com',
      roleId: 'super-admin',
      displayId: 'SA-DEVLOFT',
    ...
    LjDKyox26Bf0hDg2caHYERc9vb82: {
      uid: 'LjDKyox26Bf0hDg2caHYERc9vb82',
      name: 'Devloft Tech',
      email: 'devlofttecth@gmail.com',
      roleId: 'super-admin',
      displayId: 'SA-DEVLOFT-TYPO',
      collegeIds: ['main-campus'],
      status: 'Active',
      linkedStudentRecordIds: [],
      linkedStudentIds: [],
