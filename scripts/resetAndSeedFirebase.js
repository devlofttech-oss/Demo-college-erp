...
const schemas = {
  ...
  feeCollections: ['assignmentId', 'feeStructureId', 'feeStructureName', 'studentRecordId', 'studentId', 'studentName', 'classKey', 'batchPaymentId', 'installmentNo', 'installmentCount', 'amount', 'academicYear', 'paymentMode', 'referenceNo', 'paymentDate', 'paymentTime', 'paidAt', 'collectedBy', 'entryMode', 'manualDueItems', 'dueBeforePayment', 'totalPaidAfterPayment', 'dueAfterPayment', 'admissionThroughAgent', 'agentFee', 'agentFeePaidAmount', 'pendingAgentFeeBalance', 'status'],
